...
export async function POST(request: NextRequest) {
    try {
        ...
        // Perform AI analysis directly (without cache to simplify and avoid potential errors)
...
Return the response in JSON format with keys: overview, units, resources, studyApproach, examTips`
            ...
            try {
                ...
                analysis = {
                    overview: 'Unable to parse AI response. Please try again.',
                    units: [],
                    resources: [],
                    studyApproach: 'Review course materials systematically.',
                    examTips: 'Focus on understanding key concepts.'
                }
            }
        } catch (aiError: any) {
